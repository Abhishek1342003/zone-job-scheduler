# Fixed input for all scheduling tasks. Do not modify this list.
# PCB fields: job_id -> Process ID, priority -> scheduling priority.
# Simulation-only metadata: zone, arrival_time, burst_time.
